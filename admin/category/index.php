<section class="py-4">
    <div class="container">
        <h3 class="fw-bolder text-center">List Kategori</h3>
        <center>
        ...
        $('.dt-init').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render:function(data, type, row, meta){
                        if(row.status == 1)
                            return '<span class="badge bg-primary bg-gradient px-3 rounded-pill">Aktif</span>';
                        else
                            return '<span class="badge bg-secondary bg-gradient px-3 rounded-pill">Non Aktif</span>';
                    },
                    width:"15%"
                },
                {
            ...
            drawCallback: function(settings) {
                ...
                $('.delete_data').click(function(){
                    _conf("apa kamu yakin ingin menghapus <b>"+$(this).attr('data-name')+"</b> dari list?","delete_category",[$(this).attr('data-id')])
                })
            },
            language:{
                oPaginate: {

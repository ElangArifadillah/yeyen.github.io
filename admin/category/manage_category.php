...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bolder text-center"><b><?= isset($id) ? "Rubah Kategori" : "Buat Kategori Baru" ?></b></h2>
        <hr>
                ...
                <form action="" id="category-form" class="py-3">
                    ...
                    <div id="filter-holder">
                        <div class="input-group mb-3 input-group-dynamic <?= isset($name) ? 'is-filled' : '' ?>">
                            <label for="name" class="form-label">Nama Kategori <span class="text-primary">*</span></label>
                            <input type="text" id="name" name="name" value="<?= isset($name) ? $name : "" ?>" autofocus class="form-control">
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label for="description" class="form-label">Deskripsi Singkat <span class="text-primary">*</span></label>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="status" id="status" class="form-select rounded-0" required>
                            ...
                            <option class="px-2 py-2" value="2" <?= isset($status) && $status == 2 ? 'selected': '' ?>>Non Aktif</option>
                        </select>
                    </div>
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="./?page=category" class="btn bg-deafult border bg-gradient btn-sm w-25"><span class="material-icons">keyboard_arrow_left</span> Batal</a>
                        </div>
                    </div>
                </form>
            </div>

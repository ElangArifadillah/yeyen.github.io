...
<body class="index-page bg-gray-200">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 text-center mx-auto">
                        ...
                        <p class="lead text-white mt-3"><?= ucwords(str_replace(["_","/"]," ",$page)) === "Home" ? "" : ucwords(str_replace(["_","/"]," ",$page)) ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="confirm_modal" role='dialog' data-bs-backdrop="static">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary btn-sm rounded-0" id='confirm' onclick="">Lanjutkan</button>

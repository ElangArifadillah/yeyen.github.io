    ...
    <div class="row justify-content-center mx-0">
        <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
            <div class="card card-body shadow-blur mx-3 mx-md-4 rounded-0">
                ...
                <?php endif; ?>
                <div class="container">
                    <h4 class="fw-bolder text-center">Masuk Admin</h4>
                    <hr>
                    <br>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-sm-6">
                            <a href="<?= base_url ?>" class="text-primary">Kembali Ke Halaman Utama</a>
                        </div>
                        <div class="col-sm-6 text-end">
                            <button class="btn btn-primary bg-gradient rounded-0 mb-0">Masuk</button>
                        </div>
                    </div>
                    </form>
                </div>

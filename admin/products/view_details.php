    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <?php 
                ...
                switch($status){
                    case 0:
                        echo '<span class="badge bg-default border text-muted bg-gradient px-3 rounded-pill">Habis</span>' ;
                        break;
                    case 1:
                        echo '<span class="badge bg-primary bg-gradient px-3 rounded-pill">Tersedia</span>' ;
                        break;
                }
            ?>   
            </div>
        ...
        <div class="text-end pt-3">
            <a href="./?page=products/manage_product&id=<?= isset($id) ? $id : '' ?>" class="btn btn-primary bg-gradient btn-sm"><span class="material-icons">edit</span> Rubah</a>
            ...
            <a href="./?page=products" class="btn btn-light border btn-sm"><span class="material-icons">arrow_back_ios</span> Kembali Ke List</a>
        </div>
    </div>
</section>
<script>
    $(function(){
        $('#delete_data').click(function(){
            _conf("apa kamu yakin ingin menghapus dari list?","delete_product",['<?= isset($id) ? $id : '' ?>'])
        })

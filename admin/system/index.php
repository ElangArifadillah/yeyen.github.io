...
<section class="py-3">
    <div class="container">
        <h3 class="fw-bolder text-center">Konfigurasi Informasi Admin</h3>
        <center>
        ...
        <form action="" id="system-form">
			...
			<div class="form-group mb-3">
				<label for="" class="form-label">Tentang Toko/Admin</label>
            ...
            <div class="form-group mb-3 input-group input-group-dynamic is-filled">
				<label for="" class="form-label">Logo Toko</label>
			...
			<div class="form-group mb-3 input-group input-group-dynamic is-filled">
                <label for="" class="form-label">Background Website</label>

...
<section class="py-5">
    <div class="container">
        <h2 class="fw-bolder text-center"><b>Detail Penjual</b></h2>
        <hr>
                ...
                <dl class="row">
                    ...
                    <div class="d-flex w-100 justify-content-end">
                        <div class="col-auto me-2">
                            <a href=".?page=users/manage_user&id=<?= isset($id) ? $id : '' ?>" class="btn btn-primary bg-gradient btn-sm rounded-0 d-flex align-items-center"><span class="material-icons">edit</span> Rubah</a>
                        </div>
                        <div class="col-auto">
...
<script>
    $(function(){
        $('#delete_data').click(function(){
            _conf("Apakah kamu yakin akan menghapus list ini?","delete_user",['<?= isset($id) ? $id : '' ?>'])
        })
    })

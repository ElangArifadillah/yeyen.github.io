...
<section class="py-4">
    <div class="container">
    <h4 class="fw-bolder text-center">Update Detail Penjual</h4>
            <hr class="bg-primary">
            <br>
            <form action="" id="update-user-form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                            <label for="cpassword" class="form-label">Konfirmasi Kata Sandi Baru</label>
            ...
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-sm-6 text-end">
                    <button class="btn btn-primary bg-gradient rounded-0 mb-0">Update Akun</button>
                </div>
            </div>
            </form>
    </div>

        ...
        $('.dt-init').DataTable({
                ...
                },
                {
                    ...
                    render:function(data, type, row, meta){
                        ...
                        switch(parseInt(row.status)){
                            case 0:
                                stat =  '<span class="badge bg-default border text-muted bg-gradient px-3 rounded-pill">Habis</span>' ;
                                break;
                            case 1:
            ...
            drawCallback: function(settings) {
                ...
                $('.delete_data').click(function(){
                    _conf("apa kamu yakin ingin menghapus <b>"+$(this).attr('data-name')+"</b> dari list?","delete_product",[$(this).attr('data-id')])
                })
            },
            language:{
                oPaginate: {

...
<section class="py-3">
    <div class="container">
        <h3 class="fw-bolder text-center"><?= isset($id) ? "Update Detail Produk" : "Tambahkan Produk Baru" ?></h3>
        <center>
        ...
        <form action="" id="product-form">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="form-group mb-4">
                        <label for="category_id" class="form-label">Kategori <span class="text-primary">*</span></label>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="form-group input-group input-group-dynamic <?= isset($title) ? "is-filled" : '' ?> mb-3">
                        <label for="title" class="form-label">Nama Produk <span class="text-primary">*</span></label>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="form-group input-group input-group-dynamic <?= isset($stock) ? "is-filled" : '' ?> mb-3">
                        <label for="stock" class="form-label">Stock Produk <span class="text-primary">*</span></label>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                    <div class="form-group input-group input-group-dynamic <?= isset($selling_price) ? "is-filled" : '' ?> mb-3">
                        <label for="selling_price" class="form-label">Harga Produk <span class="text-primary">*</span></label>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group mb-3">
                        <label for="" class="form-label">Informasi Lain</label>
            ...
            <div class="form-group mb-3">
                ...
                <select name="status" id="status" class="form-select rounded-0" required>
                    <option class="px-2 py-2" value="0" <?= isset($status) && $status == 0 ? 'selected': '' ?>>Habis</option>
                    <option class="px-2 py-2" value="1" <?= isset($status) && $status == 1 ? 'selected': '' ?>>Tersedia</option>
                </select>
            </div>
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <a href="./?page=products" class="btn bg-deafult border bg-gradient btn-sm w-25"><span class="material-icons">keyboard_arrow_left</span> Batal</a>
                </div>
            </div>
        </form>
    </div>

                ...
                <div class="alert alert-success ?> rounded-0 text-light py-1 px-4 mx-3">
                    <div class="d-flex w-100 align-items-center">
                        ...
                        <div class="col-2 text-end">
                            <button class="btn m-0 text-sm" type="button" onclick="$(this).closest('.alert').remove()"><i class="material-icons mb-0">Tutup</i></button>
                        </div>
                    </div> 
                </div>
                <?php endif; ?>
                <div class="container">
                    <h4 class="fw-bolder text-center">Pendaftaran Penjual</h4>
                    <hr>
                    <br>
                    <form action="" id="register-user-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="middlename" class="form-label">Nama Tengah <small><span class="text-muted fst-italic">opsional</span></small></label>
                                    <input type="text" name="middlename" id="middlename" class="form-control form-control-lg" value="<?= isset($middlename) ?  $middlename : '' ?>" placeholder="optional">
                                </div>
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="lastname" class="form-label">Nama Belakang <span class="text-primary">*</span></label>
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="contact" class="form-label">Kontak Whatsapp # <span class="text-primary">*</span></label>
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="website" class="form-label">Website <small><span class="text-muted fst-italic">opsional</span></small></label>
                                ...
                                <div class="form-group mb-3 input-group input-group-dynamic is-filled">
                                    <label for="fb_link" class="form-label">Halaman Facebook <small><span class="text-muted fst-italic">opsional</span></small></label>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-sm-6 text-end">
                            <button class="btn btn-primary bg-gradient rounded-0 mb-0">Buat Akun</button>
                        </div>
                    </div>
                </form>
                </div>
